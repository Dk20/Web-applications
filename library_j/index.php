    ...
    <body>
     ...
     <?php include $_SERVER['DOCUMENT_ROOT'] .'/library_j/includes/header.php';?>
            <div id="page">
                <div id="content">
                    <div id="welcome">
                        <h2><b>WELCOME TO THE WONDERFUL WORLD OF READING</b></h2>
                        <!--body-->
                    <p>
					   
						YOU HAVE TO KNOW ONLY ONE THING <br>
						YOU CAN LEARN ANYTHING<br>
						For Free. For Everyone.<br><br>
						
						ARE YOU SEARCHING A BOOK....?<br>
                ...
                <div id="sidebar">
                    <ul>
                        <?php include $_SERVER['DOCUMENT_ROOT'] .'/library_j/includes/nav.php';?>
                        <!-- end navigation -->
